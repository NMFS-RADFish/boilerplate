    ...
    <GridContainer>
      <Grid row>
        <Grid col>
          <p className="text-bold text-center">
            If you have questions, please call the Permits Office at <a href="tel:888-555-5555">888-555-5555</a> or email us at <a href="mailto:permits@email.com">permits@email.com</a>.
          </p>
          ...
          <p className="text-bold text-center">
            Fields marked with a red asterisk (<abbr className="usa-hint usa-hint--required text-bold">*</abbr>) need to be filled in before submitting your application
          </p>
        </Grid>
      </Grid>
      <Grid row>
        <Grid col>
          ...
          <h2 className="app-page-divider text-center">Private Recreational Tilefish</h2>
        </Grid>
      </Grid>
      ...
      <Form className="maxw-full" onSubmit={handleSubmit}>
        <Grid row className="flex-justify-center">
          <Grid col="auto">
            <Label htmlFor="permit-year-select" className="text-bold margin-right-1 margin-top-2" requiredMarker>Permit Year:</Label>
          </Grid>
          <Grid col="auto">
            <Select
        ...
        <Grid row>
          <Grid col>
            <h2 className="app-page-divider text-center">Section 1 - Primary Vessel Owner Information</h2>
          </Grid>
        </Grid>
        <Grid row gap="md">
          ...
          <Grid tablet={{ col: true }} className="margin-bottom-3">
            <Label htmlFor="vessel-name" className="text-bold tablet:margin-top-0" requiredMarker>Vessel Name (enter "unnamed" if necessary):</Label>
