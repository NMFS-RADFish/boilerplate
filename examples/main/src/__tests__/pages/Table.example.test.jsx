...
// import Radfish from "@nmfs-radfish/radfish";
// import { generateUUID } from "@nmfs-radfish/radfish/on-device-storage/utilities/cryptoWrapper";
...
// vi.mock("dexie");
// vi.mock("@nmfs/radfish/radfish", async () => {
//   return {
//     ...(await vi.importActual("@nmfs/radfish/radfish")),
//     generateUUID: vi.fn(),
//   };
// });
...
//     // Mock generateUUID
//     Radfish.mockImplementation(() => ({
//       generateUUID: vi.fn().moockReturnValue(""),
//     }));
