(() => {
  ...
  (() => {
    ...
    const d = (e) =>
      new URL(String(e), location.href).href.replace(new RegExp("^".concat(location.origin)), "");
    function f(e, t) {
      const s = t();
    ...
    function L(e) {
      return "function" === typeof e
        ...
        : (e instanceof IDBTransaction &&
          ...
          g(e, w || (w = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]))
            ? new Proxy(e, x)
            : e);
    }
    function E(e) {
        ...
        this._upgradeDb(e),
          this._cacheName &&
            (function (e) {
              ...
              t && s.addEventListener("blocked", (e) => t(e.oldVersion, e)), E(s).then(() => {});
            })(this._cacheName);
      }
      async setTimestamp(e, t) {
        const s = { url: (e = I(e)), timestamp: t, cacheName: this._cacheName, id: this._getId(e) },
              ...
              return (
                n &&
                  i.addEventListener("upgradeneeded", (e) => {
                    n(E(i.result), e.oldVersion, e.newVersion, E(i.transaction), e);
                  }),
      ...
      async fetch(e) {
        ...
        try {
          ...
          if (i instanceof Error)
            throw new t("plugin-error-request-will-fetch", { thrownErrorMessage: i.message });
        }
        const r = n.clone();
        try {
          let e;
      ...
      async getCacheKey(e, t) {
        ...
        if (!this._cacheKeys[s]) {
          ...
          for (const e of this.iterateCallbacks("cacheKeyWillBeUsed"))
            n = O(await e({ mode: t, request: n, event: this.event, params: this.params }));
          this._cacheKeys[s] = n;
        }
    ...
    class B {
      ...
      async _awaitComplete(e, t, s, n) {
        ...
        try {
          await t.runCallbacks("handlerDidRespond", { event: n, request: s, response: a }),
            await t.doneWaiting();
        } catch (i) {
    ...
    class j extends B {
      ...
      async _handleFetch(e, s) {
        ...
        if (!this._fallbackToNetwork)
          throw new t("missing-precache-entry", { cacheName: this.cacheName, url: e.url });
        {
          0;
          const t = a.integrity,
            r = e.integrity,
      ...
      _useDefaultCacheabilityPluginIfNeeded() {
        ...
        for (const [s, n] of this.plugins.entries())
          n !== j.copyRedirectedCacheableResponsesPlugin &&
            (n === j.defaultPrecacheCacheabilityPlugin && (e = s), n.cacheWillUpdate && t++);
        0 === t
    ...
    (j.defaultPrecacheCacheabilityPlugin = {
      ...
      (j.copyRedirectedCacheableResponsesPlugin = {
        async cacheWillUpdate(e) {
          let { response: t } = e;
          return t.redirected ? await p(t) : t;
        },
      });
    class F {
      constructor() {
    ...
    const V = () => (H || (H = new F()), H);
    s(185);
    const G = (e) => (e && "object" === typeof e ? e : { handle: e });
    class $ {
      constructor(e, t) {
    ...
    let z;
    const X = () => (z || ((z = new J()), z.addFetchListener(), z.addCacheListener()), z);
    function Y(e, s, n) {
      let a;
      if ("string" === typeof e) {
        const t = new URL(e, location.href);
    ...
    self.addEventListener("activate", () => self.clients.claim()),
      (function (e) {
        ...
        { revision: null, url: "/static/media/4a1efbe82eaa84ff89ed.4a1efbe82eaa84ff89ed.woff2" },
        { revision: null, url: "/static/media/506121dad559538d44ed.506121dad559538d44ed.woff2" },
        { revision: null, url: "/static/media/5a8f743549cc6cef9a00.5a8f743549cc6cef9a00.woff2" },
        { revision: null, url: "/static/media/936869ba46988c238748.936869ba46988c238748.woff2" },
        { revision: null, url: "/static/media/9c5bf2190b2471c2f22b.9c5bf2190b2471c2f22b.woff2" },
        { revision: null, url: "/static/media/9caa42f21e4ae090b755.9caa42f21e4ae090b755.woff2" },
        { revision: null, url: "/static/media/a30c1b8fcb759e9fe728.a30c1b8fcb759e9fe728.woff2" },
        { revision: null, url: "/static/media/c63d4066b0f133fc519f.c63d4066b0f133fc519f.woff2" },
        { revision: null, url: "/static/media/c6c9fd228e87eefaf1d4.c6c9fd228e87eefaf1d4.woff2" },
        { revision: null, url: "/static/media/dc8b76b44a8a6e5fad1c.dc8b76b44a8a6e5fad1c.woff2" },
        { revision: null, url: "/static/media/e5f1a42e1c2b97e25876.e5f1a42e1c2b97e25876.woff2" },
        { revision: null, url: "/static/media/e7bccfa631a0017f31da.e7bccfa631a0017f31da.woff2" },
        { revision: null, url: "/static/media/ef69f0d737406260319a.ef69f0d737406260319a.woff2" },
        { revision: null, url: "/static/media/f1dc10a756c2c544588b.f1dc10a756c2c544588b.woff2" },
        { revision: null, url: "/static/media/f347d9834a5feacbcefb.f347d9834a5feacbcefb.woff2" },
        { revision: null, url: "/static/media/fdfa1c365bb151847b2c.fdfa1c365bb151847b2c.jpg" },
        {
          revision: "84b7f767e6cbbf2f4e887821b963d047",
          url: "/static/media/noaa-logo-circle.3a4f2da65b71c89da773479d29090181.svg",
        },
      ]),
      (function (e) {
        const t = V();
        ...
        new (class extends B {
          constructor() {
            super(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}),
              this.plugins.some((e) => "cacheWillUpdate" in e) || this.plugins.unshift(ee);
          }
          async _handle(e, s) {
          ...
          plugins: [
            new (class {
              ...
              _getCacheExpiration(e) {
                ...
                return s || ((s = new M(e, this._config)), this._cacheExpirations.set(e, s)), s;
              }
