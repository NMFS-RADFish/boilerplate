 ...
 *
 * IMPORTANT: Change theme colors in ONE place only:
 *   themes/noaa-theme/styles/_colors.scss
 *
 * The radFishThemePlugin automatically:
 *   - Parses _colors.scss and injects CSS variables
 ...
 *   - noaa-theme: Default NOAA branding
 */
...
// NOTE: Colors automatically come from themes/<theme-name>/styles/_colors.scss
const configOverrides = {
  ...
  pwa: {
    ...
    // It reads the actual color from themes/<theme-name>/styles/_colors.scss
